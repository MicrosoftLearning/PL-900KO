...
- 이 과정을 지원하기 위해 과정에 사용되는 Power Platform 서비스의 변경 사항에 맞추어 과정 콘텐츠를 수시로 업데이트해야 합니다.  따라서 플랫폼의 변경 내용을 적용하여 콘텐츠를 최신 상태로 유지하기 위해 과정 작성자와 MCT가 자유롭게 교환할 수 있도록 GitHub에 랩 지침과 랩 파일을 게시하고 있습니다.
